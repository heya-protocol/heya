...
replace (
	...
	// nhooyr.io/websocket v1.8.6 is missing; use later available version
	nhooyr.io/websocket => nhooyr.io/websocket v1.8.14
)
...
require (
	...
	github.com/CosmWasm/wasmvm/v2 v2.2.7 // indirect
