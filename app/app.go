...
func New(
	...
	// create scoped wasm keeper (after CapabilityKeeper is re-created in registerIBCModules)
	...
	app.WasmKeeper = wasmkeeper.NewKeeper(
		app.appCodec,
		runtime.NewKVStoreService(app.UnsafeFindStoreKey(wasmtypes.StoreKey).(*storetypes.KVStoreKey)),
		app.AccountKeeper,
		app.BankKeeper,
		app.StakingKeeper,
