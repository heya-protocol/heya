...
// NewRootCmd creates a new root command for nebulad. It is called once in the main function.
func NewRootCmd() *cobra.Command {
	...
	// manually register wasm module for CLI support
